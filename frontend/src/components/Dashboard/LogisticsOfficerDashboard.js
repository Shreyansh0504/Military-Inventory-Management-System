...
const LogisticsOfficerDashboard = ({
  ...
  const menuItems = [
    ...
    { id: "create-transfer", label: "Create Transfer", icon: "🔄" },
    { id: "create-purchase", label: "Create Purchase", icon: "🛒" },
  ...
  const renderContent = () => {
    switch (activeSection) {
      case "create-transfer":
        return <CreateTransfer token={token} user={user} />;
      case "create-purchase":
        return <CreatePurchase token={token} user={user} />;
      case "create-assignment":
        return <CreateAssignment token={token} user={user} />;
      default:
        return (
          <div className="overview-content">
            <h2>Logistics Officer Overview</h2>
            <div className="welcome-message">
              <p>
                ...
                Manage transfers, purchases, and assignments from here.
              </p>
